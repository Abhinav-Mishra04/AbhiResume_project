...
import MyOrders from '../Screens/My0rders';
import MyProfile from '../Screens/MyProfile';
import ExportEX from '../Screens/Export';
...
return(
   ...
   <Navbar countOfCart={countOfCart}/>
    <Routes>
        ...
        {/* <Route path='/export_to_excel' element={<ExportEX/>} /> */}
        <Route path='*' element={<Home/>}/>
    </Routes>

{/* <h1><Link to='/home'>Go To Home</Link></h1>
<h1><Link to='/about'>Go To About</Link></h1>
<h1><Link to='/contacts'>Go To Contacts</Link></h1>
