  ...
  console.log("Hello-Cart" , countOfCart)
   ...
   const handleLogout =  () =>{
    ...
    return(
        ...
        <a class="navbar-brand" href="#">SHOP-EZ</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class={`nav-item ${window.location.href.includes('/home') ? 'active' : ""}`}>
              <a style={{cursor:"pointer",color:""}} class="nav-link" onClick={()=>{navigate('/home')}}>Home <span class="sr-only">(current)</span></a>
            </li>
            ...
            <li class={`nav-item ${window.location.href.includes('/contacts') ? 'active' : ""}`}>
              <a style={{cursor:"pointer"}} class="nav-link" onClick={()=>{navigate('/contacts')}}>Contacts</a>
            </li>
