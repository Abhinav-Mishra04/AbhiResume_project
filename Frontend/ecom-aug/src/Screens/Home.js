...
// const data = [
//     {"name" : "A", "email" :"a@gmail.com", "mobile" : "9024112678"},
//     {"name" : "A", "email" :"a@gmail.com", "mobile" : "9024112678"},
//     {"name" : "A", "email" :"a@gmail.com", "mobile" : "9024112678"},
//     {"name" : "A", "email" :"a@gmail.com", "mobile" : "9024112678"},
//     {"name" : "A", "email" :"a@gmail.com", "mobile" : "9024112678"},
...
navigate((`/products/${item._id}`) , {state : {data : item}})
...
const handleSearch = (e)=>{
    ...
    return(
       ...
       {/* <ExportToExcel excelData = {data} fileName={'Excel Export'}/> */}
...
{data.map((el,i)=>(
  ...
  <div class="card-body">
    ...
    <button disable={el.disable == true ? true : false} onClick={()=>{addToCart(el)}} class="btn btn-success">{el.disable == true ? "Already Added":'Add To Cart'}</button>
